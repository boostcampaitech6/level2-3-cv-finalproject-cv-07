...
# 모델 경로 추가
model_paths = {
    "mobilenetv3": "./pretrained/mobilenetv3-large-1cd25616.pth",
}
...
def _mobilenet(arch, pretrained, progress, sync=False, **kwargs):
    if pretrained:
...
def mobilenetv3(pretrained=False, progress=True, sync=False, **kwargs):

    return _mobilenet("mobilenetv3", pretrained, progress, sync=sync, **kwargs)
